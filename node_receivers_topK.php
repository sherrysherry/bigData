<?php
	/* This file is used to handle the K influencers */
	...
	$GLOBALS['maxConnections'] = 0;
	
	/* Pass information to K influencers */
	$user_idList = explode(",", $_REQUEST['id']);
	$receivedNode = array();	
	foreach($user_idList as $user_id){
		$order = $GLOBALS['maxOrder'];
	  ...
	  array_push($receivedNode, "{$user_id}");	
	}
